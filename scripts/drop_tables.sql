...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE DRIVERS CASCADE CONSTRAINTS PURGE';
    DBMS_OUTPUT.PUT_LINE('✓ DRIVERS eliminada');
EXCEPTION
    WHEN OTHERS THEN DBMS_OUTPUT.PUT_LINE('  DRIVERS no existe');
END;
/
